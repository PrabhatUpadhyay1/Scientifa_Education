...
public class reccomendedAdapter extends RecyclerView.Adapter<reccomendedAdapter.MyViewHolder> {
    ...
    public reccomendedAdapter(List<String> list, List<String> list2, List<String> list3, List<String> list4, Context context) {
        this.list = list;
        this.list2 = list2;
        this.list3 = list3;
        this.list4 = list4;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putStringArrayListExtra("list2", (ArrayList<String>) list2);
                intent.putStringArrayListExtra("list3", (ArrayList<String>) list3);
                intent.putStringArrayListExtra("list4", (ArrayList<String>) list4);
